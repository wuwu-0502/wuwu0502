...
(function() {
  ...
  /**
    ...
    baidu.object.extend(InfoBox.prototype,{
		 ...
		 *
		 * alter by tg 20130619
		 * 给img的style添加display:none;
         */
        _getCloseIcon: function(){
            var img = "<img src='"+ this._opts.closeIconUrl +"' align='right' style='position:absolute;right:0px;cursor:pointer;margin:"+ this._opts.closeIconMargin +";display:none;'/>";
            return img;
        },
        /**
	     * 设置infoBox的内容
